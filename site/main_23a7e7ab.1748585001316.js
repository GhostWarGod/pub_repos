...
var _configureChains = (0,chunk_GISSYJN5/* configureChains */.te)([chains_dist/* bsc */.NB
  //   bscTestnet,
...
// EXTERNAL MODULE: ./node_modules/@tonconnect/sdk/lib/esm/index.mjs + 1 modules
var esm = __webpack_require__(1876);
// EXTERNAL MODULE: ./node_modules/@tonconnect/ui-react/lib/index.mjs + 1 modules
var lib = __webpack_require__(1720);
// EXTERNAL MODULE: ./node_modules/antd/es/message/index.js + 127 modules
var message = __webpack_require__(1370);
...
var jotai_esm = __webpack_require__(2837);
;// ./src/hook/useSessionChainId.ts

var sessionChainIdAtom = (0,jotai_esm/* atom */.eU)(0);
...
function useConnectWallet() {
  var _useConnect = (0,wagmi_dist/* useConnect */.eF)({
...
function useGetOwnAddress() {
  var _useAccount = (0,wagmi_dist/* useAccount */.F7)(),
...
var queryChainIdAtom = (0,jotai_esm/* atom */.eU)(-1);
...
function Header() {
  ...
  var _message$useMessage = message/* default */.Ay.useMessage(),
  ...
  var _useState5 = (0,react.useState)("https://snake.cryptoarena.io?lang=en"),
  ...
  (0,react.useEffect)(function () {
    if ((i18n == null ? void 0 : i18n.language) === "zhCN") {
      setGamesUrl("https://snake.cryptoarena.io?lang=zh-cn");
    } else if ((i18n == null ? void 0 : i18n.language) === "zhTW") {
      setGamesUrl("https://snake.cryptoarena.io?lang=zh");
    } else {
      setGamesUrl("https://snake.cryptoarena.io?lang=en");
    }
  }, [i18n.language]);
...
function comm1_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
...
var comm1_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm1_templateObject || (comm1_templateObject = comm1_taggedTemplateLiteralLoose(["\n\tposition: relative;\n\theight: 100%;\n\n\t.comm1_conters {\n\t    position: absolute;\n\t\ttop: 50%;\n\t\twidth: 100%;\n\t\theight: 440px;\n\t\tmargin-top: -220px;\n\t\ttext-align: center;\n\t\tz-index: 99;\n\t\tanimation: upDown 2s linear infinite;\n\t}\n\t.comm1_tit1 {\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 56px;\n\t\t\tcolor: #FBBD15;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 78px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 22px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t}\n\t\timg {\n\t\t    margin-top: 10px;\n\t\t}\n\t}\n\t.comm1_tit2 {\n\t    margin-top: 30px;\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 56px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 52px;\n\t\t\ttext-shadow: 0 0 5px rgb(255, 255, 255, 0.35);\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 22px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tmargin-top: 15px;\n\t\t}\n\t}\n\n\n\t@media (max-width: 1600px) {\n\t\t.comm1_conters {\n\t\t\theight: 400px;\n\t\t\tmargin-top: -200px;\n\t\t}\n\t\t.comm1_tit1 {\n\t\t\tspan {\n\t\t\t\tfont-size: 32px;\n\t\t\t\tline-height: 50px;\n\t\t\t}\n\t\t\tem {\n\t\t\t\tfont-size: 18px;\n\t\t\t}\n\t\t\timg {\n\t\t\t    margin-top: 20px;\n   \t\t\t\tmargin-bottom: 20px;\n\t\t\t\twidth: 500px;\n\t\t\t}\n\t\t}\n\t\t.comm1_tit2 {\n\t\t    margin-top: 10px;\n\t\t\tspan {\n\t\t\t\tfont-size: 28px;\n\t\t\t\tline-height: 40px;\n\t\t\t}\n\t\t\tem {\n\t\t\t\tfont-size: 18px;\n\t\t\t}\n\t\t}\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\t.comm1_conters {\n\t\t\twidth: 86%;\n        \tleft: 7%;\n\t\t\tmargin-top: -220px;\n\t\t}\n\t\t.comm1_img {\n\t\t\timg {\n\t\t\t\twidth: 80px;\n\t\t\t}\n\t\t}\n\t\t.comm1_tit1 {\n\t\t\tspan {\n\t\t\t\tfont-size: 28px;\n\t\t\t\tline-height: 30px;\n    \t\t\tmargin-bottom: 20px;\n\t\t\t}\n\t\t\tem {\n\t\t\t\tfont-size: 14px;\n\t\t\t}\n\t\t\timg {\n\t\t\t   \twidth: 80%;\n\t\t\t}\n\t\t}\n\t\t.comm1_tit2 {\n\t\t\tspan {\n\t\t\t\tfont-size: 28px;\n\t\t\t\tline-height: 30px;\n\t\t\t}\n\t\t\tem {\n\t\t\t\tfont-size: 14px;\n\t\t\t}\n\t\t}\n\t}\n"])));
function Comm1() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm1M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
...
var comm1M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm1M_templateObject || (comm1M_templateObject = comm1M_taggedTemplateLiteralLoose(["\n\tposition: relative;\n\tmin-height: 100vh;\n\n\t.comm1_conters {\n\t    position: absolute;\n\t\ttop: 50%;\n\t\twidth: 86%;\n\t\theight: 440px;\n\t\tleft: 7%;\n\t\tmargin-top: -240px;\n\t\tz-index: 99;\n\t\tanimation: upDown 2s linear infinite;\n\t}\n\t.comm1_tit1 {\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 28px;\n\t\t\tcolor: #FBBD15;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 30px;\n    \t\tmargin-bottom: 20px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 13px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t}\n\t\timg {\n\t\t\twidth: 80%;\n\t\t    margin: 30px 0;\n\t\t}\n\t}\n\t.comm1_tit2 {\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 25px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 30px;\n\t\t\ttext-shadow: 0 0 5px rgb(255, 255, 255, 0.35);\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 14px;\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t\tmargin-top: 15px;\n\t\t}\n\t}\n\t.comm1_img {\n\t    margin-bottom: 25px;\n\t\timg {\n\t\t\twidth: 60px;\n\t\t\tmargin-left: -10px;\n\t\t}\n\t}\n\t.comm1_wallet {\n\t\tbackground: url(", ") no-repeat;\n\t\tbackground-size: 100%;\n\t\twidth: 228px;\n\t\theight: 51px;\n\t\tline-height: 51px;\n\t\tfont-size: 14px;\n\t\tcolor: #631C1D;\n\t\tfont-weight: bold;\n\t\tfont-family: \"swissek\";\n\t\ttext-align: center;\n\t\tmargin-top: 50px;\n\t}\n"])), anniu_namespaceObject);
function Comm1M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm2_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
...
function comm2M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm2M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm2M_templateObject || (comm2M_templateObject = comm2M_taggedTemplateLiteralLoose(["\n\tmin-height: 100vh;\n\t.comm2_title {\n\t\tmargin-top: 110px;\n\t\tpadding: 0 20px;\n\t\tspan {\n\t\t\tfont-size: 22px;\n\t\t\tline-height: 30px;\n\t\t}\n\t\tem {\n\t\t\tfont-size: 20px;\n\t\t\tline-height: 30px;\n\t\t}\n\t}\n\t.comm2_list {\n\t    display: flex;\n\t\tjustify-content: center;\n\t\tgap: 10px;\n\t\tflex-wrap: wrap;\n\t\tmargin: 0 20px;\n\t\tspan {\n\t\t\twidth: calc(50% - 5px);\n\t\t\theight: auto;\n\t\t\taspect-ratio: 339 / 457;\n\t\t\tmargin-bottom: 20px;\n\t\t}\n\t\tem {\n\t\t    display: block;\n\t\t\ttext-align: center;\n\t\t\tfont-size: 13px;\n\t\t\tfont-weight: bold;\n\t\t\tcolor: #FFFFFF;\n\t\t\tline-height: 18px;\n\t\t\ttext-shadow: rgb(0, 0, 0, 0.26) 3px 0px 0px;\n\t\t\tmargin: auto;\n\t\t\tpadding-top: 70%;\n\t\t\ttext-align: left;\n\t\t\twidth: 85%;\n\t\t}\n\t}\n\t.comm2_bg1 {\n\t\tbackground: url(", ") center no-repeat;\n    \tbackground-size: cover;\n\t}\n\t.comm2_bg2 {\n\t\tbackground: url(", ") center no-repeat;\n    \tbackground-size: cover;\n\t}\n\t.comm2_bg3 {\n\t\tbackground: url(", ") center no-repeat;\n    \tbackground-size: cover;\n\t}\n\t.comm2_bg4 {\n\t\tbackground: url(", ") center no-repeat;\n    \tbackground-size: cover;\n\t}\n"])), comm2_1_namespaceObject, comm2_2_namespaceObject, comm2_3_namespaceObject, comm2_4_namespaceObject);
function Comm2M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm3_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
...
var comm3_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm3_templateObject || (comm3_templateObject = comm3_taggedTemplateLiteralLoose(["\n\tbackground: url(", ") top center no-repeat;\n    background-size: cover;\n\n\t.comm3_conter {\n\t    display: flex;\n\t\talign-items: center;\n\t\twidth: 75%;\n\t}\n\t.comm3_right {\n\t\ttext-align: right;\n\t\tmargin-top: 40px;\n\t\tmargin-right: 6%;\n\t}\n\t.comm3_xian {\n\t    margin: 40px 0;\n\t}\n\t.comm3_des {\n\t\tfont-size: 18px;\n\t\tline-height: 30px;\n\t\ttext-shadow: 1px 2px 0px rgba(0, 0, 0, 0.16);\n\t\tfont-family: \"swissek\";\n\t\tfont-weight: bold;\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t}\n\t}\n\t.comm3_flex_tit {\n\t\tdisplay: flex;\n    \tjustify-content: right;\n\t}\n\n\n\t@media (max-width: 1600px) {\n\t\t.comm3_conter {\n\t\t\twidth: 90%;\n\t\t}\n\t\t.comm3_left {\n\t\t\twidth: 35%;\n\t\t\timg {\n\t\t\t\twidth: 600px;\n\t\t\t}\n\t\t}\n\t\t.comm3_right {\n\t\t\twidth: 65%;\n\t\t}\n\t\t.comm3_xian {\n\t\t\tmargin: 20px 0px;\n\t\t}\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\tbackground: url(", ") top center no-repeat;\n\t\tbackground-size: cover;\n\n\t\t.comm3_conter {\n\t\t    flex-direction: column-reverse;\n    \t\twidth: 90%;\n\t\t}\n\t\t.comm3_xian {\n\t\t    margin: 10px 0px;\n\t\t\timg {\n\t\t\t\twidth: 80%;\n\t\t\t}\n\t\t}\n\t\t.comm3_left {\n\t\t    width: 100%;\n\t\t\tmargin-top: -50px;\n\t\t\timg {\n\t\t\t\twidth: 360px;\n\t\t\t}\n\t\t}\n\t\t.comm3_right {\n\t\t    width: 100%;\n\t\t\ttext-align: center;\n\t\t\tmargin-right: 0px;\n\t\t}\n\t\t.comm3_des {\n\t\t\tfont-size: 16px;\n    \t\tline-height: 20px;\n\t\t\tspan {\n\t\t\t\tmargin-bottom: 10px;\n\t\t\t}\n\t\t}\n\t\t.comm3_flex_tit {\n\t\t\tjustify-content: center;\n\t\t}\n\t}\n"])), home_bg3_namespaceObject, home_bg3_m_namespaceObject);
function Comm3() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm3M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm3M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm3M_templateObject || (comm3M_templateObject = comm3M_taggedTemplateLiteralLoose(["\n\tmin-height: 100vh;\n\t.comm3_tit {\n\t\tmargin-top: 110px;\n\t}\n\t.comm3_flex_tit {\n\t\tdisplay: flex;\n\t}\n\t.comm_m_conter {\n\t\tposition: relative;\n\t\tbackground: url(", ") center no-repeat;\n    \tbackground-size: cover;\n\t\twidth: 100%;\n\t\theight: auto;\n\t\taspect-ratio: 750 / 1134;\n\t\tpadding-top: 32%;\n\t}\n\t.comm_m_icos {\n\t    display: flex;\n    \talign-items: center;\n\t\twidth: 66%;\n    \tmargin: auto;\n\t\timg {\n\t\t    width: 65px;\n\t\t}\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 13px;\n\t\t\tline-height: 18px;\n\t\t\ttext-shadow: 1px 2px 0px rgba(0,0,0,0.33);\n\t\t\tfont-family: \"swissek\";\n\t\t\tfont-weight: bold;\n\t\t}\n\t}\n\t.comm_m_conter1 {\n\t\tposition: absolute;\n\t\ttop: 22%;\n\t\tleft: 17%;\n\t}\n\t.comm_m_conter2 {\n\t\tposition: absolute;\n\t\ttop: 36%;\n\t\tleft: 17%;\n\t}\n\t.comm_m_conter3 {\n\t\tposition: absolute;\n\t\ttop:51%;\n\t\tleft: 17%;\n\t}\n\t.comm_m_conter4 {\n\t\tposition: absolute;\n\t\ttop: 65%;\n\t\tleft: 17%;\n\t}\n"])), comm3_m_bg_namespaceObject);
function Comm3M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm4_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/rules-of-hooks */
...
var comm4_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm4_templateObject || (comm4_templateObject = comm4_taggedTemplateLiteralLoose(["\n\tbackground: url(", ") top center no-repeat;\n\tbackground-size: cover;\n\n\t.comm2_xian {\n\t\tmargin-top: 20px;\n    \tmargin-bottom: 40px;\n\t}\n\t.comm4_conters {\n\t\theight: 210px;\n\t    text-align: left;\n\t\tpadding: 35px 20px;\n\t\tem {\n\t\t\tdisplay: block;\n\t\t}\n\t\ti {\n\t\t\tdisplay: block;\n\t\t\tfont-family: \"swisse\";\n\t\t\tmargin-top: 10px;\n\t\t\tmargin-bottom: 60px;\n\t\t\tfont-weight: 500;\n\t\t}\n\t}\n\n\n\t@media (max-width: 1600px) {\n\t\t.comm2_xian {\n\t\t\tmargin-top: 10px;\n    \t\tmargin-bottom: 20px;\n\t\t\timg {\n\t\t\t\twidth: 500px;\n\t\t\t}\n\t\t}\n\t\t.comm4_conters {\n\t\t\tpadding: 20px;\n\t\t\ti {\n\t\t\t\tmargin-bottom: 20px;\n\t\t\t}\n\t\t}\n\t}\n"])), home_bg4_namespaceObject);
function Comm4() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm4M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm4M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm4M_templateObject || (comm4M_templateObject = comm4M_taggedTemplateLiteralLoose(["\n\t.comm4_tit {\n\t\tmargin-top: 60px;\n\t}\n\t.comm4_bgico {\n\t    background: linear-gradient(90deg, #451A90, #7D278A);\n\t\tbox-shadow: 6px 17px 51px 0px rgba(0, 0, 0, 0.63);\n\t\tborder-radius: 14px;\n\t\tmargin-bottom: 15px;\n\t\timg {\n\t\t\twidth: 100%;\n\t\t\tborder-radius: 14px 14px 0 0;\n\t\t}\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tpadding: 15px 15px 20px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-family: \"swissek\";\n\t\t}\n\t\ti {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 12px;\n\t\t\tfont-family: \"swisse\";\n\t\t\tline-height: 17px;\n\t\t\tmargin-top: 5px;\n\t\t}\n\t}\n"])));
function Comm4M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm5_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
...
function comm5M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm5M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm5M_templateObject || (comm5M_templateObject = comm5M_taggedTemplateLiteralLoose(["\n\t.comm2_list {\n\t\tdisplay: flex;\n\t\tjustify-content: center;\n\t\tflex-wrap: wrap;\n\t\tmargin: 30px 10px 0px;\n\t\tspan {\n\t\t\tdisplay: flex;\n\t\t\talign-items: center;\n\t\t\tmargin-top: -40px;\n\t\t\twidth: calc(50% - 5px);\n\t\t\theight: auto;\n\t\t\taspect-ratio: 355 / 579;\n\t\t\tmargin-bottom: 40px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\ttext-align: center;\n\t\t\tfont-size: 12px;\n\t\t\tfont-weight: bold;\n\t\t\tcolor: #FFFFFF;\n\t\t\tline-height: 20px;\n\t\t\ttext-shadow: rgb(0, 0, 0, 0.26) 3px 0px 0px;\n\t\t\tmargin: auto;\n\t\t\tpadding-top: 50px;\n\t\t}\n\t}\n\t.comm2_bg1 {\n\t\tbackground: url(", ") center no-repeat;\n\t\tbackground-size: cover;\n\t\tem {\n\t\t\twidth: 70%;\n\t\t}\n\t}\n\t.comm2_bg2 {\n\t\tbackground: url(", ") center no-repeat;\n\t\tbackground-size: cover;\n\t\tem {\n\t\t\twidth: 80%;\n\t\t}\n\t}\n\t.comm2_bg3 {\n\t\tbackground: url(", ") center no-repeat;\n\t\tbackground-size: cover;\n\t}\n\t.comm2_bg4 {\n\t\tbackground: url(", ") center no-repeat;\n\t\tbackground-size: cover;\n\t\tem {\n\t\t\twidth: 80%;\n\t\t\tpadding-top: 75px;\n\t\t}\n\t}\n\t.comm_tit {\n\t\tmargin-top: 40px;\n\t}\n"])), comm5_1_m_namespaceObject, comm5_2_m_namespaceObject, comm5_3_m_namespaceObject, comm5_4_m_namespaceObject);
function Comm5M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm6_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/rules-of-hooks */
...
var comm6_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm6_templateObject || (comm6_templateObject = comm6_taggedTemplateLiteralLoose(["\n\tbackground: url(", ") top center no-repeat;\n\tbackground-size: cover;\n\n\t.comm2_xian {\n\t\tmargin-top: 20px;\n    \tmargin-bottom: 40px;\n\t}\n\n\n\t@media (max-width: 1600px) {\n\t\t.comm2_xian {\n\t\t\tmargin-top: 10px;\n    \t\tmargin-bottom: 20px;\n\t\t\timg {\n\t\t\t\twidth: 500px;\n\t\t\t}\n\t\t}\n\t\t.comm6_part {\n\t\t\timg {\n\t\t\t\twidth: 850px;\n\t\t\t}\n\t\t}\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\tbackground: url(", ") top center no-repeat;\n\t\tbackground-size: cover;\n\n\t\t.comm2_xian {\n\t\t\tmargin-top: 10px;\n\t\t\tmargin-bottom: 30px;\n\t\t\timg {\n\t\t\t\twidth: 80%;\n\t\t\t}\n\t\t}\n\t\t.comm6_part {\n\t\t\timg {\n\t\t\t\twidth: 90%;\n\t\t\t}\n\t\t}\n\t}\n"])), home_bg6_namespaceObject, home_bg6_m_namespaceObject);
function Comm6() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm6M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm6M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm6M_templateObject || (comm6M_templateObject = comm6M_taggedTemplateLiteralLoose(["\n\t.comm6_part {\n\t    margin: 0 20px;\n\t\timg {\n\t\t\twidth: 100%;\n\t\t}\n\t}\n"])));
function Comm6M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm7_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/rules-of-hooks */
...
var comm7_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm7_templateObject || (comm7_templateObject = comm7_taggedTemplateLiteralLoose(["\n\tbackground: url(", ") top center no-repeat;\n\tbackground-size: cover;\n\n\t.comm2_xian {\n\t\tmargin-top: 20px;\n    \tmargin-bottom: 40px;\n\t}\n\t.comm7_flex {\n\t    display: flex;\n\t\twidth: 1150px;\n\t\tmargin: auto;\n\t\tgap: 40px;\n\t}\n\t.comm7_conter {\n\t\tdisplay: flex;\n    \talign-items: center;\n\t\twidth: 50%;\n\t\tspan {\n\t\t\tfont-size: 14px;\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 30px;\n\t\t\ttext-shadow: 1px 2px 0px rgba(0,0,0,0.16);\n\t\t\ttext-align: left;\n    \t\tmargin-left: -20px;\n\t\t}\n\t}\n\n\n\t@media (max-width: 1600px) {\n\t\t.comm2_xian {\n\t\t\tmargin-top: 10px;\n    \t\tmargin-bottom: 20px;\n\t\t\timg {\n\t\t\t\twidth: 500px;\n\t\t\t}\n\t\t}\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\tbackground: url(", ") top center no-repeat;\n\t\tbackground-size: cover;\n\n\t\t.comm2_xian {\n\t\t\tmargin-top: 10px;\n\t\t\tmargin-bottom: 0px;\n\t\t\timg {\n\t\t\t\twidth: 80%;\n\t\t\t}\n\t\t}\n\t\t.comm7_flex {\n\t\t\tdisplay: block;\n    \t\twidth: 100%;\n\t\t}\n\t\t.comm7_conter {\n\t\t\tdisplay: block;\n\t\t\twidth: 100%;\n\t\t\tspan {\n\t\t\t\tdisplay: block;\n\t\t\t\twidth: 80%;\n\t\t\t\tmargin: auto;\n\t\t\t\ttext-align: center;\n\t\t\t\tline-height: 20px;\n\t\t\t\tmargin-top: -30px;\n\t\t\t}\n\t\t}\n\t}\n"])), home_bg7_namespaceObject, home_bg7_m_namespaceObject);
function Comm7() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm7M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm7M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm7M_templateObject || (comm7M_templateObject = comm7M_taggedTemplateLiteralLoose(["\n\t.comm7_flex {\n\t\tdisplay: block;\n    \twidth: 100%;\n\t}\n\t.comm7_conter {\n\t\tdisplay: block;\n\t\twidth: 100%;\n\t\timg {\n\t\t\twidth: 80px;\n\t\t\tmargin-left: -15px;\n\t\t}\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\twidth: 80%;\n\t\t\tfont-size: 14px;\n\t\t\tfont-weight: bold;\n\t\t\tline-height: 20px;\n\t\t\ttext-shadow: 1px 2px 0px rgba(0,0,0,0.16);\n\t\t\tmargin-bottom: 30px;\n\t\t}\n\t}\n"])));
function Comm7M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm8_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/rules-of-hooks */
...
var comm8_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm8_templateObject || (comm8_templateObject = comm8_taggedTemplateLiteralLoose(["\n    background: #14171F;\n\n\t.comm8_flex {\n\t\tdisplay: flex;\n\t\twidth: 1100px;\n\t\tmargin: auto;\n\t\tpadding: 35px 0 35px 100px;\n\t}\n\t.comm8_conter {\n\t\twidth: 25%;\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 16px;\n\t\t\tcolor: #FFCC00;\n\t\t\tline-height: 20px;\n\t\t\tfont-weight: bold;\n\t\t\tmargin-bottom: 30px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 12px;\n\t\t\tcolor: #fff;\n\t\t\tfont-weight: 500;\n\t\t\tline-height: 16px;\n\t\t\tmargin-bottom: 20px;\n\t\t}\n\t\ta {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 12px;\n\t\t\tcolor: #fff;\n\t\t\tfont-weight: 500;\n\t\t\tline-height: 16px;\n\t\t\tmargin-bottom: 20px;\n\t\t\t&:hover {\n\t\t\t\tcolor: #FFCC00;\n\t\t\t}\n\t\t}\n\t\ti {\n\t\t\tdisplay: flex;\n\t\t}\n\t\timg {\n\t\t\tmargin-right: 20px;\n\t\t}\n\t}\n\t.comm8_reserved {\n\t\theight: 60px;\n\t\tline-height: 60px;\n\t\tborder-top: 1px solid #343945;\n\t\ttext-align: center;\n\t\tfont-size: 12px;\n\t}\n\n\n\t@media (max-width: 750px) {\n\t\tposition: relative;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tjustify-content: center;\n\t\talign-items: center;\n\t\ttext-align: center;\n\n\t\t.comm8_flex {\n\t\t    display: block;\n\t\t\twidth: 100%;\n\t\t\tpadding: 0px;\n\t\t\tmargin: 0px;\n\t\t\ttext-align: center;\n\t\t}\n\t\t.comm8_conter {\n\t\t\twidth: 100%;\n\t\t\tmargin-bottom: 40px;\n\t\t\tspan {\n\t\t\t    margin-bottom: 10px;\n\t\t\t}\n\t\t\tem {\n\t\t\t    margin-bottom: 5px;\n\t\t\t}\n\t\t\ta {\n\t\t\t    margin-bottom: 5px;\n\t\t\t}\n\t\t\timg {\n\t\t\t\twidth: 30px;\n\t\t\t}\n\t\t\t:last-child {\n\t\t\t\tmargin-bottom: 0;\n\t\t\t}\n\t\t}\n\t\t.comm8_reserved {\n\t\t\tdisplay: none;\n\t\t}\n\t}\n"])));
function Comm8() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function comm8M_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var comm8M_CustomStyle = styled_components_browser_esm/* default */.Ay.div(comm8M_templateObject || (comm8M_templateObject = comm8M_taggedTemplateLiteralLoose(["\n\t.comm8_flex {\n\t\tdisplay: block;\n\t\twidth: 100%;\n\t\tpadding: 0px;\n\t\tmargin: 0px;\n\t}\n\t.comm8_conter {\n\t\twidth: 100%;\n\t\tmargin-bottom: 40px;\n\t\tspan {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 16px;\n\t\t\tcolor: #FFCC00;\n\t\t\tline-height: 20px;\n\t\t\tfont-weight: bold;\n\t\t\tmargin-bottom: 20px;\n\t\t}\n\t\tem {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 14px;\n\t\t\tcolor: #fff;\n\t\t\tfont-weight: 500;\n\t\t\tline-height: 16px;\n\t\t\tmargin-bottom: 15px;\n\t\t\topacity: .8;\n\t\t}\n\t\ta {\n\t\t\tdisplay: block;\n\t\t\tfont-size: 14px;\n\t\t\tcolor: #fff;\n\t\t\tfont-weight: 500;\n\t\t\tline-height: 16px;\n\t\t\tmargin-bottom: 5px;\n\t\t\t&:hover {\n\t\t\t\tcolor: #FFCC00;\n\t\t\t}\n\t\t}\n\t\ti {\n\t\t\tdisplay: flex;\n\t\t}\n\t\timg {\n\t\t\twidth: 30px;\n\t\t\tmargin-right: 20px;\n\t\t}\n\t\t:last-child {\n\t\t\tmargin-bottom: 0;\n\t\t}\n\t}\n\t.comm8_reserved {\n\t\theight: 60px;\n\t\tline-height: 60px;\n\t\tborder-top: 1px solid #343945;\n\t\tfont-size: 12px;\n\t}\n"])));
function Comm8M() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n,
    t = _useTranslation.t;
...
function index_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var index_CustomStyle = styled_components_browser_esm/* default */.Ay.div(index_templateObject || (index_templateObject = index_taggedTemplateLiteralLoose(["\n\tposition: relative;\n\theight: 100%;\n"])));

// const tonConnectUI = new TonConnectUI({
// 	manifestUrl: 'https://7c3e-222-65-14-140.ngrok-free.app/tonconnect-manifest.json',
// });

var tonConnect = new esm/* TonConnect */.GE({
  // manifestUrl: 'https://7c3e-222-65-14-140.ngrok-free.app/tonconnect-manifest.json'
...
function Index() {
  ...
  // 			setTpAddress(walletInfo.account.address);
  // 		}
  // 	});
  // }, []);
  ...
  // 		setIsTelegram(true);
  // 		window.Telegram.WebApp.expand(); // 展开全屏
  ...
  // 		const telegramWallet = walletsList.find(w => w.name === 'Wallet');
  ...
  }, /*#__PURE__*/react.createElement(lib/* TonConnectUIProvider */.Nl, {
    manifestUrl: "https://cryptoarena.io/tonconnect-manifest.json",
    uiPreferences: {
      theme: lib/* THEME */.CV.DARK
    },
...
function WalletComponent() {
  var _useTonConnectUI = (0,lib/* useTonConnectUI */.Lg)(),
    tonConnectUI = _useTonConnectUI[0];
  var wallet = (0,lib/* useTonWallet */.c5)();
  console.log('tonConnectUI===>', tonConnectUI);

  // const userFriendlyAddress = TonWeb.utils.Address
  // .parseAddress(wallet.account.address)
          ...
          case 3:
            ...
            request = {
              ...
              messages: [{
                ...
                amount: "0",
                // 0 TON
                payload: "Your message to sign" // 直接传入字符串
              }]
            };
            _context4.next = 8;
            return tonConnectUI.sendTransaction(request);
          case 8:
            result = _context4.sent;
            console.log("交易 BOC（含签名）:", result.boc);
            _context4.next = 15;
            break;
          case 12:
            _context4.prev = 12;
            _context4.t0 = _context4["catch"](3);
            console.error('签名失败:', _context4.t0);
          case 15:
          case "end":
  ...
  return /*#__PURE__*/react.createElement("div", null, wallet ? /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("p", null, "Connected wallet: ", wallet.name), /*#__PURE__*/react.createElement("p", null, "Account address: ", wallet.account.address), /*#__PURE__*/react.createElement("button", {
    onClick: handleSign
  }, "\u7B7E\u540D"), /*#__PURE__*/react.createElement("button", {
...
function main_taggedTemplateLiteralLoose(e, t) { return t || (t = e.slice(0)), e.raw = t, e; }
/* eslint-disable react-hooks/exhaustive-deps */
...
var main_CustomStyle = styled_components_browser_esm/* default */.Ay.div(main_templateObject || (main_templateObject = main_taggedTemplateLiteralLoose(["\n\twidth: 100%;\n\tmin-height: 100vh;\n\tbackground: url(", ") no-repeat;\n\tbackground-size: cover;\n\n\t.games_pro {\n\t\twidth: 1256px;\n\t\theight: 728px;\n\t\tbackground: url(", ") no-repeat;\n\t\tbackground-size: 100%;\n\t\tmargin: auto;\n\t\ttext-align: center;\n\t\tposition: absolute;\n\t\tleft: 50%;\n\t\ttop: 50%;\n\t\tmargin-left: -628px;\n\t\tmargin-top: -364px;\n\t}\n\n\n\t@media (max-width: 1400px) {\n\t\t.header_left {\n\t\t\tgap: 0px;\n\t\t}\n\t}\n\n"])), game_bj_namespaceObject, games_kuang_namespaceObject);
function Game() {
  var _useTranslation = (0,dist_es/* useTranslation */.Bd)(),
    i18n = _useTranslation.i18n;
  var _useState = (0,react.useState)("https://snake.cryptoarena.io?lang=en"),
...
var metaMaskConnector = new metaMask/* MetaMaskConnector */.j({
  chains: chains,
  options: {
...
var injectedConnector = new chunk_2VZS2JHJ/* InjectedConnector */.s({
  chains: chains,
  options: {
    shimDisconnect: false,
    shimChainChangedDisconnect: true
...
var app_client = (0,wagmi_dist/* createClient */.UU)({
  autoConnect: true,
  provider: provider,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [912], () => (__webpack_require__(3777)))
