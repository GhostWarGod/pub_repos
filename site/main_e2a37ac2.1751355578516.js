...
function Stats() {
  ...
  return /*#__PURE__*/react.createElement(stats_main_CustomStyle, null, contextHolder, /*#__PURE__*/react.createElement("div", {
    ...
    alt: ""
  }), /*#__PURE__*/react.createElement("i", null, t("Online Users")), /*#__PURE__*/react.createElement("span", null, "--"))));
}
...
function useChainList_useCurrentChain(chain) {
  ...
  // 获取useChainsList()里chainID=chain?.id的数组，如果没有的话返回chain，有就返回查询到的数据
...
function AirDrop() {
  ...
  const [inputContractAddress, setInputContractAddress] = (0,react.useState)(''); // 输入合约地址
  const [inputAddress, setInputAddress] = (0,react.useState)(); // 目标地址
  const [inputNumber, setInputNumber] = (0,react.useState)(); // 空投数量
  const [curSymbol, setCurSymbol] = (0,react.useState)();
  const [curDecimals, setCurDecimals] = (0,react.useState)();
  ...
  const [curTokenError, setCurTokenError] = (0,react.useState)(false);
  ...
  const handleTokenData = async () => {
    if (inputContractAddress && inputContractAddress.length > 20) {
      try {
        const contract = new web3.eth.Contract(const_abiErc20, inputContractAddress);
        try {
          if (address && contract) {
            ...
            const balanceBig = new bignumber/* default */.A(balance.toString()).shiftedBy(-decimals).toFixed(4);
        ...
        try {
          ...
          try {
            if (address && contract) {
              ...
              const allowanceBig = new bignumber/* default */.A(allowance.toString()).shiftedBy(-curDecimals).toFixed(4);
  ...
  const hadnleApprove = async () => {
    if (inputContractAddress === "") {
      messageApi.open({
        type: 'error',
        content: t('Please enter the contract address')
      });
      return;
    }
  ...
  const hadnleSend = async () => {
    ...
    await contract.methods.multiDepositToken(inputContractAddress, targetAddressArray, amount, appId).send({
      from: address,
      gasPrice: gas
    }, (err, result) => {
      if (err) {
  ...
  return /*#__PURE__*/react.createElement(airDrop_main_CustomStyle, null, contextHolder, /*#__PURE__*/react.createElement("div", {
  ...
  }, t("Contract Address")), /*#__PURE__*/react.createElement(input/* default */.A, {
    type: "text",
    ...
    className: "ari_error"
  }, curTokenError && /*#__PURE__*/react.createElement("i", null, t('Contract address error'))), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Balance"), ":"), curTokenQuery ? /*#__PURE__*/react.createElement(Loader_Dots, null) : /*#__PURE__*/react.createElement("em", null, curBalance !== "--" ? Number(Number(curBalance).toFixed(4)).toLocaleString() : curBalance, " ", curSymbol)))), /*#__PURE__*/react.createElement("div", {
    className: "ari_contersbg"
  }, /*#__PURE__*/react.createElement("div", {
    className: "ari_titles"
  ...
  }, /*#__PURE__*/react.createElement("span", null, t('Approve'))) : /*#__PURE__*/react.createElement("div", null, curSymbol && curDecimals ? /*#__PURE__*/react.createElement("div", null, inputNumber && targetAddressArray.length > 0 ? /*#__PURE__*/react.createElement("div", null, curApproveNumber >= inputNumber * targetAddressArray.length ? /*#__PURE__*/react.createElement("div", {
    className: "ari_buttom",
    onClick: () => hadnleSend()
    ...
    className: "ari_buttom ari_notbuttom"
  }, /*#__PURE__*/react.createElement("span", null, t('Approve')))) : /*#__PURE__*/react.createElement("div", {
    className: "ari_buttom ari_notbuttom"
...
function WalletComponent() {
  ...
  const hadnleSend = async () => {
    ...
    // const contract = new web3.eth.Contract(
    // 	abiAirDrop,
    // 	addressAirDropContract[chain?.id],
    // );
    ...
    // await contract.methods.multiDepositToken(inputContractAddress, targetAddressArray, amount, appId).send({ from: address, gasPrice: gas }, (err, result) => {
    // 	if (err) {
    // 		setIsSendLoading(false)
    // 		messageApi.open({
    // 			type: 'error',
  ...
  return /*#__PURE__*/React.createElement(telegramMain_CustomStyle, null, contextHolder, /*#__PURE__*/React.createElement("div", {
    ...
    className: "ari_buttom",
    onClick: () => connectWallet()
  }, t("Connect"), "--telegram") : /*#__PURE__*/React.createElement(React.Fragment, null, isContractConfig ? /*#__PURE__*/React.createElement("div", {
    className: "ari_buttom ari_notbuttom"
  }, /*#__PURE__*/React.createElement("span", null, t('Approve'))) : /*#__PURE__*/React.createElement("div", null, curSymbol && curDecimals ? /*#__PURE__*/React.createElement("div", null, inputNumber && targetAddressArray.length > 0 ? /*#__PURE__*/React.createElement("div", null, curApproveNumber >= inputNumber * targetAddressArray.length ? /*#__PURE__*/React.createElement("div", {
    className: "ari_buttom",
    onClick: () => hadnleSend()
  }, !isSendLoading && /*#__PURE__*/React.createElement("span", null, t('Send')), isSendLoading && /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(Dots, null, t('Send')))) : /*#__PURE__*/React.createElement("div", {
    className: "ari_buttom",
    onClick: () => hadnleApprove()
  }, !isApproveLoading && /*#__PURE__*/React.createElement("span", null, t('Approve')), isApproveLoading && /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(Dots, null, t('Approve'))))) : /*#__PURE__*/React.createElement("div", {
    className: "ari_buttom ari_notbuttom"
  }, /*#__PURE__*/React.createElement("span", null, t('Approve')))) : /*#__PURE__*/React.createElement("div", {
    className: "ari_buttom ari_notbuttom"
  }, /*#__PURE__*/React.createElement("span", null, t('Approve'))))), /*#__PURE__*/React.createElement("div", {
...
function JettonTransfer() {
  ...
  const sendTransaction = async () => {
    try {
      ...
      // const jettonWalletAddress = Address.parse("EQCxE6mUtQJKFnGfaROTKOt1lZbDiiX1kCixRv7Nw2Id_sDs");
      const depositContractAddress = Address.parse("EQA-Cqat_LrDMQEF19HoVuRLYlq5s78Ax9ZYpxjpWyuVGH5i");
      const appId = 1;
      const perAmount = toNano(amount);
      const totalAmount = perAmount * toNano(addresses.length);
      console.log("perAmount===>", perAmount);
      console.log("totalAmount===>", totalAmount);
      console.log("addresses===>", addresses);

      // 构建 address list cell
      const addressCells = addresses.map(addr => beginCell().storeAddress(Address.parse(addr)).endCell());
      console.log("addressCells===>", addressCells);
      const treeCell = beginCell();
      addressCells.forEach(c => treeCell.storeRef(c));
      const addressTree = treeCell.endCell();

      // 构建 forwardPayload
      const forwardPayload = beginCell().storeUint(appId, 32).storeUint(addresses.length, 32).storeCoins(perAmount).storeRef(addressTree).endCell();

      // 构建 Jetton transfer body
      const body = beginCell().storeUint(0xf8a7ea5, 32) // op
      .storeUint(0, 64) // query id
      .storeCoins(totalAmount).storeAddress(depositContractAddress).storeAddress(jettonWalletAddress).storeMaybeRef(null).storeCoins(toNano("0.02")) // forward gas
      ...
      await tonConnectUI.sendTransaction({
        ...
        messages: [{
          ...
          // address: 'UQCtWbiu8_A8_3sz3UBGJ4gx7A7TOQhslQiUR87rsBm23BNg',
          // address: 'UQDpTgMTP1xQX4_nY5siH4QuFMrfAzraVBzY4AisKqQ_pJ7t',
  ...
  }, "Jetton \u6279\u91CF\u8F6C\u8D26"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, addresses.map((addr, idx) => /*#__PURE__*/React.createElement("input", {
    key: idx,
    type: "text",
    placeholder: "\u8F93\u5165\u94B1\u5305\u5730\u5740",
    value: addr,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [815], () => (__webpack_require__(32105)))
