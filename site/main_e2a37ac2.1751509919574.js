...
function useTokenList() {
  const tokensList = [{
    ...
    iconUrl: "http://cryptoarena.io/images/token/USDT.png"
  }, {
    chainID: 56,
    symbol: 'USDT',
    decimals: 18,
    ...
    iconUrl: "http://cryptoarena.io/images/token/BULL.png"
  }, {
    chainID: 56,
    symbol: 'BABYDOGE',
    decimals: 9,
    contract: "0xc748673057861a797275CD8A068AbB95A902e8de",
    iconUrl: "http://cryptoarena.io/images/token/BABYDOGE.png"
  }, {
    chainID: 56,
    symbol: 'SHIB',
    decimals: 18,
    contract: "0x2859e4544c4bb03966803b044a93563bd2d0dd4d",
    iconUrl: "http://cryptoarena.io/images/token/SHIB.png"
  }, {
    chainID: 56,
    symbol: 'PEPE',
    decimals: 18,
    contract: "0x25d887Ce7a35172C62FeBFD67a1856F20FaEbB00",
    iconUrl: "http://cryptoarena.io/images/token/PEPE.png"
  }, {
    chainID: 56,
    symbol: 'FLOKI',
    decimals: 9,
    contract: "0xfb5B838b6cfEEdC2873aB27866079AC55363D37E",
    iconUrl: "http://cryptoarena.io/images/token/FLOKI.png"
  }, {
    chainID: 56,
    symbol: 'COCO',
    decimals: 18,
    contract: "0xf563e86e461de100cfcfd8b65daa542d3d4b0550",
    iconUrl: "http://cryptoarena.io/images/token/COCO.png"
  }];
  return tokensList;
}
...
function AirDrop() {
  ...
  }, /*#__PURE__*/react.createElement("span", null, t("Select airdrop symbol")), /*#__PURE__*/react.createElement(es_select/* default */.A, {
...
function JettonTransfer() {
  ...
  const sendTransaction = async () => {
    try {
      ...
      .storeMaybeRef(null)
      // .storeRefMaybe(null)
      .storeCoins(toNano("0.5")) // forward TON for contract processing
      .storeRef(forwardPayload)
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [815], () => (__webpack_require__(84762)))
